...
Every Crop Counts, Every Farmer Matters.         </h1>
</div>
</div>
...
<img decoding="async" width="366" height="9" src="https://demo.7iquid.com/donalfarm/wp-content/uploads/2024/06/pt-layer.webp" className="attachment-full size-full wp-image-721" alt="" />			</div>		</div>
</div>
...
<a href="https://demo.7iquid.com/donalfarm/our-services/" className="pxl-btn btn-white icon-ps-right has-icon">
<span className="pxl-button-text">See Our Services</span>
<span className="pxl-icon"><span aria-hidden="true" className="pxl-button-icon right pxli pxli-angle-right2"></span></span>    </a>
</div>		</div>
</div>
            </div>
</div>
...
Agriculture that works for the future         </h1>
</div>
</div>
...
Every Day Is A Good Day To Be A Farmer         </h1>
</div>
</div>
          ...
          <div className="elementor-element elementor-element-2a684c3 elementor-widget elementor-widget-pxl_image" data-id="2a684c3" data-element_type="widget" data-widget_type="pxl_image.default">
            <div className="elementor-widget-container">
              <div id="pxl_image-2a684c3-2021" className="pxl-image-wg d-flex pxl-draw-from-left default">
                <img decoding="async" width={81} height={15} src="https://demo.7iquid.com/donalfarm/wp-content/uploads/2024/06/pxl-heading-shap.webp" className="attachment-full size-full wp-image-1057" alt />			</div>		</div>
          </div>
                      ...
                      <div className="pxl-fancybox-wrap d-flex text-center layout-4">
                        <div className="fancybox-inner relative">
                          ...
                          <div className="pxl-fancybox-content relative">
                            ...
                            <a className="link-readmore d-inline-flex" href="https://demo.7iquid.com/donalfarm/services/clean-vegetables/" target="_blank">                <span className="icon-readmore d-inline-flex">
                      ...
                      <div className="pxl-fancybox-wrap d-flex text-center layout-4">
                        <div className="fancybox-inner relative">
                          ...
                          <div className="pxl-fancybox-content relative">
                            ...
                            <div className="desc">
                              Ultrices sagittis orci a scelerisque purus semper eget duis at. Sollicitudin nibh sit amet commodo nulla.          </div>
                            <a className="link-readmore d-inline-flex" href="https://demo.7iquid.com/donalfarm/services/pure-cows-milk/" target="_blank">                <span className="icon-readmore d-inline-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 986.06 250.15"><path className="cls-1" d="M1104,159.89c-310.41-20.26-620.86-24.67-931.39.75-.2-1.38-.39-2.75-.59-4.13,2.07-.81,4.1-2.12,6.22-2.37,36.74-4.41,73.47-8.92,110.24-13,171.87-18.92,344.23-20,516.61-16.56,93.56,1.88,187.07,7.21,280.6,11,3.34.14,6.67,0,11.64,0-40.79-36.36-82.36-69-120.66-106.37l1.63-3.08c2.45,1.15,5.09,1.95,7.32,3.51q54.2,37.7,108.3,75.54c14.1,9.84,28.16,19.77,42.44,29.26,14,9.32,15.06,19.3,2.16,30.78A117.32,117.32,0,0,1,1117,180.76q-73.41,39.88-147.17,78.9a50.76,50.76,0,0,1-18.18,5.06c-2.55.27-6.9-2.78-7.73-5.43s.81-8,2.91-9.86c4.29-3.9,9.51-6.58,14.54-9.27q71.56-38.37,143.2-76.55C1104.34,162.37,1104.16,161.13,1104,159.89Z" transform="translate(-166.49 -19.59)" /></svg>              </span>
                            </a> 
                          </div> 
                        </div>  
                      ...
                      <div className="pxl-fancybox-wrap d-flex text-center layout-4">
                        <div className="fancybox-inner relative">
                          ...
                          <div className="pxl-fancybox-content relative">
                            ...
                            <div className="desc">
                              Ultrices sagittis orci a scelerisque purus semper eget duis at. Sollicitudin nibh sit amet commodo nulla.          </div>
                            <a className="link-readmore d-inline-flex" href="https://demo.7iquid.com/donalfarm/services/clean-chicken-and-eggs/" target="_blank">                <span className="icon-readmore d-inline-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 986.06 250.15"><path className="cls-1" d="M1104,159.89c-310.41-20.26-620.86-24.67-931.39.75-.2-1.38-.39-2.75-.59-4.13,2.07-.81,4.1-2.12,6.22-2.37,36.74-4.41,73.47-8.92,110.24-13,171.87-18.92,344.23-20,516.61-16.56,93.56,1.88,187.07,7.21,280.6,11,3.34.14,6.67,0,11.64,0-40.79-36.36-82.36-69-120.66-106.37l1.63-3.08c2.45,1.15,5.09,1.95,7.32,3.51q54.2,37.7,108.3,75.54c14.1,9.84,28.16,19.77,42.44,29.26,14,9.32,15.06,19.3,2.16,30.78A117.32,117.32,0,0,1,1117,180.76q-73.41,39.88-147.17,78.9a50.76,50.76,0,0,1-18.18,5.06c-2.55.27-6.9-2.78-7.73-5.43s.81-8,2.91-9.86c4.29-3.9,9.51-6.58,14.54-9.27q71.56-38.37,143.2-76.55C1104.34,162.37,1104.16,161.13,1104,159.89Z" transform="translate(-166.49 -19.59)" /></svg>              </span>
                            </a> 
                          </div> 
                        </div>  
                      ...
                      <div className="pxl-fancybox-wrap d-flex text-center layout-4">
                        <div className="fancybox-inner relative">
                          ...
                          <div className="pxl-fancybox-content relative">
                            ...
                            <div className="desc">
                              Ultrices sagittis orci a scelerisque purus semper eget duis at. Sollicitudin nibh sit amet commodo nulla.          </div>
                            <a className="link-readmore d-inline-flex" href="https://demo.7iquid.com/donalfarm/services/fertilizer-products/" target="_blank">                <span className="icon-readmore d-inline-flex">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 986.06 250.15"><path className="cls-1" d="M1104,159.89c-310.41-20.26-620.86-24.67-931.39.75-.2-1.38-.39-2.75-.59-4.13,2.07-.81,4.1-2.12,6.22-2.37,36.74-4.41,73.47-8.92,110.24-13,171.87-18.92,344.23-20,516.61-16.56,93.56,1.88,187.07,7.21,280.6,11,3.34.14,6.67,0,11.64,0-40.79-36.36-82.36-69-120.66-106.37l1.63-3.08c2.45,1.15,5.09,1.95,7.32,3.51q54.2,37.7,108.3,75.54c14.1,9.84,28.16,19.77,42.44,29.26,14,9.32,15.06,19.3,2.16,30.78A117.32,117.32,0,0,1,1117,180.76q-73.41,39.88-147.17,78.9a50.76,50.76,0,0,1-18.18,5.06c-2.55.27-6.9-2.78-7.73-5.43s.81-8,2.91-9.86c4.29-3.9,9.51-6.58,14.54-9.27q71.56-38.37,143.2-76.55C1104.34,162.37,1104.16,161.13,1104,159.89Z" transform="translate(-166.49 -19.59)" /></svg>              </span>
                            </a> 
                          </div> 
                        </div>  
